...
@section('body')
    <table class="content">
        <tr>
            <td>
                @if($toAdmin)
                    <h3 style="margin-bottom: 0">Recibimos un nuevo pedido</h3>
                @else
                    <h3 style="margin-bottom: 0">Recibimos tu pedido</h3>
                @endif
            </td>
        </tr>
        <tr>
            ...
            <td class='bg-white font-90' style='padding: 15px;'>
                <table>
                    ...
                    <tr>
                        ...
                        <td class='text-left'>${{$pedido->getFormatoPrecio($producto->pivot->precio*$producto->pivot->cantidad*(1-($producto->pivot->descuento_porcentaje/100)))}}</td>
                    </tr>
                    <tr>
